...
export async function getQuests(p: any) { await delay(); return db.list(p) }
export async function getQuest(id: number) { await delay(); return db.get(id)! }
export async function postQuest(p: any) { await delay(); return db.create(p) }
