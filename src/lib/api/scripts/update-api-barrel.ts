...
const GENERATED_ROOT = resolve(process.cwd(), 'src/lib/api/generated');
const HEADER = [
  '/* eslint-disable */',
...
if (!pathExists(GENERATED_ROOT)) {
  throw new Error(`Generated directory does not exist: ${GENERATED_ROOT}`);
}
