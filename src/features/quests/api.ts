...
export const useCreateQuest = useFake ? mock.useCreateQuest : real.useCreateQuest
export const useUpdateQuest = useFake ? mock.useUpdateQuest : real.useUpdateQuest
export const useDeleteQuest = useFake ? mock.useDeleteQuest : real.useDeleteQuest
export const useToggleVisibility = useFake ? mock.useToggleVisibility : real.useToggleVisibility
